...
# Offset Físico para alinear el centro de rotación con la curva
...
try:
    while True:
        # Si perdemos conexión con la cámara
        ...
        # Calcula el ángulo directo hacia la meta basado en la cámara
        ...
        if angulo_vision_anterior is None:
            ...
            yaw_recta_base = obtener_yaw() # Guardamos el rumbo perfecto de la recta
        ...
        if abs(dif_vision) > 45: 
            ...
            if contador_esquinas == 1 or contador_esquinas == 3:
                ...
                time.sleep(0.3) # Esquina virtual, pausa corta
        ...
        # =================================================================
        # FUSIÓN SENSORIAL: CONTROL CASCADA (Visión corrige al IMU)
        # =================================================================
        
        # 1. Error Lateral (¿Hacia dónde ve la cámara la meta?)
        ...
        # Actualizamos la meta del IMU
        yaw_objetivo_local = yaw_recta_base + correccion_vision

        # 3. Control Interno Rápido (El IMU ejecuta)
        ...
        # Ajuste de velocidad según la cercanía

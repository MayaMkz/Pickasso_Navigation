...
PLACE_ALTURA_Z_M    = 0.07  # Deja caer el cubo 7 cm por encima del ArUco
        ...
        while rclpy.ok():
            ...
            while cubos_en_plataforma < 3 and rclpy.ok():
                ...
                if self._ciclo_pick(cubo_encontrado.point):
                    ...
                    # 1. Subida a posición segura antes de entrar a la plataforma
                    ...
                    # 3. Subida a posición segura después de dejar el cubo
                    self._ir_a_posicion_articular(PRE_PLATFORM_JOINTS)
                ...
                # Regreso a Home para buscar el siguiente
                self._ir_a_posicion_articular(HOME_JOINTS)
                self._busy = False
            ...
            for iteracion in range(cubos_en_plataforma):
                ...
                if cubo_plataforma is None:
                    self.get_logger().error('No se detectó el cubo en la plataforma a pesar del conteo. Omitiendo iteración.')
                    continue
